 ...
 */
class PhoneBook {
    val phoneBook = HashMap<String, MutableSet<String>>()
    ...
    override fun equals(other: Any?): Boolean {
        if ((other as? PhoneBook) != null) {
            if (this.phoneBook.size != other.phoneBook.size) return false
            for ((k, v) in phoneBook) {
                if (!other.phoneBook.containsKey(k)) return false
                if (!other.phoneBook.containsValue(v)) return false
            }
        }
        return true
    }
